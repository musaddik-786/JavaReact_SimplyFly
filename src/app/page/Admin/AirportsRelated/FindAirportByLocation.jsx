...
import './FindAirportByLocation.css'; // Specific styling for FindAirportByLocation

const FindAirportByLocation = () => {
  ...
  const handleInputChange = (e) => {
    setLocation(e.target.value); // Update location based on user input
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'No airports found for this location'); // Handle errors
...
export default FindAirportByLocation;
