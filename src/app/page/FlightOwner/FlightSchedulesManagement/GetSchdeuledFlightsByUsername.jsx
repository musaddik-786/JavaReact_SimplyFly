  ...
  return (
    <>
      ...
      <div className="scheduled-flight-list-container">
        <h1>List of Scheduled Flights for {localStorage.getItem('username')}</h1>
        {scheduledFlights.length > 0 ? (
          ...
          <p>No scheduled flights found for this owner.</p>
        )}
      </div>
    </>
  );
...
export default GetScheduledFlightsByUsername;
...
//       try {
//         const token = localStorage.getItem('token');
//         const response = await fetch(`http://localhost:8080/simply-fly/flightTrips/owner/${username}`, {
//           headers: {
//             'Content-Type': 'application/json',
//             'Authorization': token,
//           },
